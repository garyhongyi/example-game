    ...
    public class ServiceList
    {
        public static readonly List<ServiceConfig> List = new List<ServiceConfig>()
        {
            ...
            new ServiceConfig()
            {
                ...
                displayName = "UniTask",
                description = "UniTask",
                gitUrl = "https://e.coding.net/unitychina/uos/UniTask.git?path=/src/UniTask/Assets/Plugins/UniTask",
                serviceType = ServiceType.Library.ToString(),
                launched = true,
            },
            new ServiceConfig()
            ...
            new ServiceConfig()
            {
                ...
                launched = true,
                docUrl = "https://uos.unity.cn/doc/push",
                gitUrl = "https://e.coding.net/unitychina/uos/PushMessageStorage.git",
                versionUrl =
                    "https://unitychina.coding.net/api/user/unitychina/project/uos/shared-depot/PushMessageStorage/git/blob/master/package.json",
                devPortalPath = "/services/{Settings.AppID}/push",
